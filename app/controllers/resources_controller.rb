class ResourcesController < ApplicationController
  ...
  def by_label
    label = Resource.find_by literal: params[:literal].upcase
    @resource = Resource.find(label.parents.first.subject_id)
    if @resource
  ...
  private
    ...
    def set_resource
      @resource = Resource.find_by literal: params[:literal]
    end
